...
class Index extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      videoProfile: '480p_4',
      response: false,
      endpoint: "https://transtreaming-europa.herokuapp.com"
          ...
          <section className="login-wrapper">
            ...
            <div className="login-body">
              ...
              <div className="columns" style={{display:"none"}}>
                ...
                <div className="column is-5" style={{display:"none"}}>
                  <AdvancedOptions
  ...
  render() {
    ...
    return (
      <div className={this.state.active ? 'dropdown is-active' : 'dropdown'}>
        <div className="dropdown-trigger"
          onClick={() => this.setState({ 'active': !this.state.active })}>
          <a id="language" className="ag-rounded button" aria-haspopup="true" aria-controls="languageOptions">
            <span id="baseOptionLabel">{this.state.language}</span>
            <span className="icon is-small">
              <i className="ag-icon ag-icon-arrow-down" aria-hidden="true"></i>
            </span>
          </a>
        </div>
        <div className="dropdown-menu" id="languageOptions" role="menu">
          <div className="dropdown-content">
            {options}
          </div>
        </div>
